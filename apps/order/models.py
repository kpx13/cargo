...
class Order(models.Model):
    ...
    sender_phone = models.CharField(u'Контактный телефон', max_length=255)
    sender_name = models.CharField(u'ФИО отправителя', max_length=255)
    ...
    receiver_city = models.CharField(u'Город', max_length=255)
